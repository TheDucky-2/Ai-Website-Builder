    ...
    <div className="w-full max-w-5xl mx-auto z-20 max-md:px-4 min-h-[80vh]">
      ...
      <div className="text-center mt-16">
        ...
        <p className="mx-auto text-center text-sm max-w-md mt-10 text-white/60 font-light">
          Project <span className="text-white"> Creation / Revision </span> consumes <span className="text-white"> 5 credits </span>. 
          <br/>You can purchase additional credits to create more projects.
        </p>
