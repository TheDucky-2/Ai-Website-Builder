...
const MyProjects = () => {
  ...
  try{
        const confirmation = confirm("Are your sure you want to delete this project?")

        if(!confirmation) return ;

        const {data} = await api.delete(`/user/projects/${projectId}`)
          ...
          {projects.map((project)=> (
            ...
            shadow-md group hover:shadow-indigo-700/30 hover:border-indigo-800/80 transition-all duration-300'>
              ...
              <div onClick={(e)=> e.stopPropagation()}>
                ...
                <TrashIcon onClick={()=> deleteProject(project.id)} 
